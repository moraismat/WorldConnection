...
public class DBService {
    ...
    public void instantiateTestDataBase() throws ParseException {
        ...
        phoneNumber.add("+5583998569851");
        phoneNumber.add("+5686332556987");

        ArrayList<String> languageSpoken = new ArrayList<>();
        languageSpoken.add("english");
        languageSpoken.add("portuguese");
        ...
        UserForeign userForeign = new UserForeign(null, 1, "Peter Parker","09/10/1984",  "+55098555678901", phoneNumber,"peter_parker@gmail.com",
                languageSpoken, "Student", dataSchool, addressForeign, 5896555136484664L, "United States of America");

        ArrayList<String> phoneNumber2 = new ArrayList<>();
        phoneNumber.add("+9858669875412");
        phoneNumber.add("+5583998589658");

        ArrayList<String> languageSpoken2 = new ArrayList<>();
        languageSpoken.add("english");
        languageSpoken.add("japanese");
        languageSpoken.add("portuguese");
        ...
        UserCandidate userCandidate = new UserCandidate(null, 2, "Eduardo Sousa", "10/02/1970", "+558332568954", phoneNumber2, "eduardosousa@hotmail.com", languageSpoken2,
                                                        "Professor", dataSchool2, addressCandidate, 908765432L, 10000.00, residenceData, 987568092L, 2);
